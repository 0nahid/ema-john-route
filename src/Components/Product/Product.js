                ...
                <div className="shadow-sm p-3 rounded">
                    <Row>
                        <Col lg={12} style={{ height: '21rem' }}>
                            ...
                            <p><Link style={{ textDecoration: 'none', color:'black' }} to={`/product/` + key}>{name}</Link></p></Col>
                        ...
                        <Col lg={12}>
                            ...
                            {props.showAddToCart && <Button variant="dark" className="mb-3" onClick={() => props.handleAddProduct(product)}> <FaCartPlus /> Add To Cart</Button>}
                        </Col>
                    </Row>
                </div>
            </Col>
